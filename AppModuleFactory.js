...
class AppModuleFactory extends Tapable {
	constructor(context, resolverFactory, options) {
		...
		this._pluginCompat.tap("AppModuleFactory", options => {
			switch (options.name) {
				case "before-resolve":
				case "after-resolve":
					options.async = true;
		...
		this.hooks.factory.tap("AppModuleFactory", () => (result, callback) => {
		...
		this.hooks.resolver.tap("AppModuleFactory", () => (data, callback) => {
			const contextInfo = data.contextInfo;
			const context = data.context;
			const request = data.request;

			const appResolver = this.getResolver("app", { filesystem: new AppVirtualFileSystem() })
...
module.exports = AppModuleFactory;
